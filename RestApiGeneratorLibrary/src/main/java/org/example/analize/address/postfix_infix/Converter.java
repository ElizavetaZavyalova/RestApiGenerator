...
import static org.example.analize.address.postfix_infix.Converter.Operand.*;
import static org.example.analize.address.postfix_infix.Converter.RegExp.FIND_OPERATOR_OR_BRACKET;
import static org.example.analize.address.postfix_infix.Converter.RegExp.NOT_DELETE_EMPTY_STRING_ON_END;
...
public class Converter {
    ...
    static Queue<String> toPostfix(String condition) throws IllegalArgumentException {
