...
public class GetTest {
    ...
    void ConstructorParams(String req, List<String> par) {
        ...
        log.info(req);
        GetRequest request = new GetRequest(req, par, endpoint,true,true,false);
    ...
    void ConstructorParamsThrow(String req, List<String> par) {
        Endpoint endpoint = makeEndpoint();
        log.info(req);
        var ex = assertThrows(IllegalArgumentException.class, () -> new GetRequest(req, par, endpoint,true,true,false));
